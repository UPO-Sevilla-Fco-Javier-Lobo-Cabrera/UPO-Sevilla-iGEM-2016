/* UPO-SEVILLA iGEM TEAM 2016. Information on how to use this sofware at: http://2016.igem.org/Team:UPO-Sevilla/Software  */
...
int lectura_compuestos(double a[][SIZECOMPUESTOS])
{
	...
	if(g==NULL)
	{
		printf("\n\Error opening input_compuestos.txt file.\n\n");
	}
...
int lectura_reacciones(double b[][SIZEREACCIONES])
{
	...
	if(h==NULL)
	{
		printf("\n\nError opening input_reacciones.txt file.\n\n");
	}
...
int lectura_parametros(double c[][SIZEREACCIONES])
{
	...
	if(m==NULL)
	{
		printf("\n\n Error opening input_parametros.txt file. \n\n");
	}
...
int main()
{
	...
	if(m==NULL)
	{
		printf("\n\nError opening output1.txt file.\n\n");
	}
    n=fopen("output2.txt","at");
	if(n==NULL)
	{
		printf("\n\nError opening output2.txt file.\n\n");
	}
